...
const PaidGiftTaxReturns = () => {
    ...
    const getGiftTaxReturns = async () => {
      try {
        const response = await Axios.get("https://smart-tax-api.vercel.app/api/gift-returns/paid");
    ...
    // change title
    useEffect(() => {
      document.title = "Paid Gift Tax Returns | SMART TAX";
      getGiftTaxReturns();
    }, []);
    ...
    return (
      ...
      <Box>
        <Header title="Gift Tax Returns" subtitle="All PAID Gift Tax Returns Data" />
        <Box
          m="0 0 5px 5px"
          height="100vh"
          sx={{
  ...
  export default PaidGiftTaxReturns;