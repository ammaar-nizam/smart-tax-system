...
const PaidEDTReturns = () => {
    ...
    const getEdtReturns = async () => {
      try {
        const response = await Axios.get("https://smart-tax-api.vercel.app/api/edt-returns/paid");
    ...
    // change title
    useEffect(() => {
      document.title = "Paid EDT Returns | SMART TAX";
      getEdtReturns();
    }, []);
    ...
    return (
      ...
      <Box>
        <Header title="EDT Returns" subtitle="All PAID EDT Returns Data" />
        <Box
          m="0 0 5px 5px"
          height="100vh"
          sx={{
