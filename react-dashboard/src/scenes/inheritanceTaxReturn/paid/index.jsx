...
const PaidInheritanceTaxReturns = () => {
    ...
    const getInheritanceReturns = async () => {
      try {
        const response = await Axios.get("https://smart-tax-api.vercel.app/api/inheritance-returns/paid");
    ...
    // change title
    useEffect(() => {
      document.title = "Paid Inheritance Returns | SMART TAX";
    ...
    return (
      ...
      <Box>
        <Header title="Inheritance Returns" subtitle="All PAID Inheritance Returns Data" />
        <Box
          m="0 0 5px 5px"
          height="100vh"
          sx={{
  ...
  export default PaidInheritanceTaxReturns;